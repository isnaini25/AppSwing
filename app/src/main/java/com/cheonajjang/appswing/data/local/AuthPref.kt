package com.cheonajjang.appswing.data.local

import android.content.Context
import android.content.SharedPreferences
import com.cheonajjang.appswing.data.model.ActionState
import com.cheonajjang.appswing.data.model.AuthUser
import com.cheonajjang.appswing.util.getObject
import com.cheonajjang.appswing.util.putObject
...
class AuthPref (val context:Context){
    ...
    suspend fun login(email: String, password: String): ActionState<AuthUser>{
        val user = authUser
        return if(user == null){
            ActionState(message = "Anda beum terdaftar", isSuccess = false)
